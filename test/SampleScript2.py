...
def TBI_BRB_A(GMDataX,GMDataY, Dt, T1=None,T2=None, SupressOutput=True, Viewer = False, Animation = False, PushOver=False, OpenSeesCommand = 'OpenSeesSP', TestingModeOff=True):
    ...
    if not(PushOver):
        ...
        OSAnalysisHelper.SolutionAlgorithim(OData,Dt/5,1e-6,5)
        OSAnalysisHelper.SolutionAlgorithim(OData,Dt/10,1e-5,10)
        OSAnalysisHelper.SolutionAlgorithim(OData,Dt/20,1e-4,20)
        OSAnalysisHelper.SolutionAlgorithim(OData,Dt/40,1e-5,40)
