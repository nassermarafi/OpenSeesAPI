...
def CreateColumn(XGrid, YGrid): #YGrid must be more than 0
    ...
    OData.AddElement(OpenSeesAPI.Model.Element.Element.ElasticBeamColumn(OData.GetFreeElementId(5,1), BaseSubNode,TopSubNode, Acol, E, Icol, GeoTransfLinear))
...
def CreateBeam(StartXGrid, EndXGrid, YGrid): #YGrid must be more than 0
    ...
    Ks = 6.0*E*Ibeam/(YGrids[YGrid]-YGrids[YGrid-1])*n
    ...
    OData.AddElement(OpenSeesAPI.Model.Element.Element.ElasticBeamColumn(OData.GetFreeElementId(6,1), StartSubNode,EndSubNode, Abeam, E, Ibeam, GeoTransfLinear))
...
OData.AddElement(OpenSeesAPI.Model.Element.Element.ElasticBeamColumn(OData.GetFreeElementId(8,1),BasePDNode,FirstStoryPDNode,1e6, 1e6, 1e-2, GeoTransfPDelta))
OData.AddElement(OpenSeesAPI.Model.Element.Element.ElasticBeamColumn(OData.GetFreeElementId(8,1),FirstStoryPDNode,SecondStoryPDNode,1e6, 1e6, 1e-2, GeoTransfPDelta))
...
OData.AddObject(OpenSeesAPI.Analysis.Numberer.RCM())
OData.AddObject(OpenSeesAPI.Analysis.System.BandGeneral())
OData.AddObject(OpenSeesAPI.Analysis.Test.EnergyIncr(1e-6, 1000))
OData.AddObject(OpenSeesAPI.Analysis.Algorithm.KrylovNewton())
